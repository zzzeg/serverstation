<template>
  <div class="mpvue-calendar" ref="calendar">
    <div class="calendar-tools" v-if="!isMonthRange">
        <div style="width: 50%;" >
            <div @click="selectYear(year-1)" class='triangle' style = 'margin-left: 80upx;'></div>
            <div class="triangle-year">{{year}}</div>
            <div  @click="selectYear(year+1)" class='triangle-r' style = 'margin-left: 220upx;margin-top: -50upx;'></div>
        </div>
        <div style="width: 50%;" >
            <div @click="prev" class='triangle' style = 'margin-left: 80upx;'></div>
            <div class="triangle-year">{{monthText}}</div>
            <div  @click="next" class='triangle-r' style = 'margin-left: 200upx; margin-top: -50upx;'></div>
        </div>
      ...
      >
        ...
        <tr v-for="(day,k1) in days" :key="k1" :class="{'gregorianStyle': !lunar}">
          ...
          >
            ...
            <view v-if="child.rangeClassName == 'mc-range-begin' " class="mc-text" style="color: #FFFFFF;">
                始
            </view>
            <view v-if="child.rangeClassName == 'mc-range-end' " class="mc-text" style="color: #FFFFFF;">
                终
            </view>
