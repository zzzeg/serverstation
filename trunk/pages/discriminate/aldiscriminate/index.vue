    ...
    <view class="content">
        <view class="sssssss" @touchmove.stop.prevent="moveHandle" :style="{ height: screenHeight }">
            ...
            <view class="contentBox">
                ...
                <button v-if="!showEnvelope" style="top: 780upx;" :animation="animationBtnData" @click="clickDiscriminate"  class="discriminate-btn" :class="{btnopacity:isActive}">提交辨证</button>
    ...
    export default {
    	...
    	methods: {
            ...
            clickSuccees:function(){
                uni.removeStorageSync("AlInfo")
                uni.navigateTo({
                    url:"../report?recordid="+this.rid+"&type=1"
                })
            },
            clickDiscriminate:function(){
                ...
                if(this.firstStepState && this.theSecondState && this.theThirdState){
                    ...
                    console.log(alInfo)
                    api.dialWithQuesTest({
                        data:alInfo
                    }).then(res => {
                        console.log('dialWithQuesTest')
                        console.log(res)
                        if(res.status === 'OK'){
                            uni.removeStorageSync("AlInfo")
