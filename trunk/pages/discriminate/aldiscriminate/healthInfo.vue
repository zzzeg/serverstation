            ...
            <view :style="{ height: cardHeight + 'px', top:contentTop +'px'}"  class="contentBox " :class="[isShow == 1 ? 'animationNext' : isShow == 0 ? 'animation' : isShow == 2 ? 'animationPre' : 'animationPrevious']" >
                <view  class="cardBox">
                    ...
                    <scroll-view>
                        ...
                        <view class="answer">
                            <view v-for="(item,index) in questionNow.answer" :key = 'index' class="answerItem" @click="clickAnswer('now',index,item.value)" :class="{selectAnswer: questionNow.value.indexOf(item.value)>-1 }" >
                                {{item.label}}
                            </view>
                        </view>
                    </scroll-view>
            ...
            <view v-if="!isFirst" :style="{ height: cardHeight + 'px'}"  class="contentBox" :class="[isShow == 0 ? 'animationNext' : isShow == 1 ? 'animation' : isShow == 2 ? 'animationPrevious' : 'animationPre']" >
                <view  class="cardBox">
                    <scroll-view>
                        ...
                        <view class="answer">
                            <view v-for="(item,index) in questionNext.answer" :key = 'index' class="answerItem" @click="clickAnswer('next',index,item.value)" :class="{selectAnswer: questionNext.value.indexOf(item.value)>-1 }" >
                                {{item.label}}
                            </view>
                        </view>
                    </scroll-view>
